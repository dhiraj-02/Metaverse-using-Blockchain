...
var canvas = document.createElement("canvas");
    ...
    const model = useGLTF("http://localhost:3000/office/chair.glb")
  ...
  //model.scene.add(cube);
    ...
    return (
    <>
    <object3D position={[70,1.2,18]} scale={[9,9,9]} rotation={[0,-1.57,0]}>
    <OrbitControls ref={controlsRef} />
    <primitive object={model.scene.clone()}/>;
    </object3D>

    <object3D position={[70,1.2,-2.5]} scale={[9,9,9]} rotation={[0,1.57,0]}>
    <OrbitControls ref={controlsRef} />
    <primitive object={model.scene.clone()}/>;
    </object3D>

    <object3D position={[60,1.2,-2.5]} scale={[9,9,9]} rotation={[0,1.57,0]}>
    <OrbitControls ref={controlsRef} />
    <primitive object={model.scene.clone()}/>;
    </object3D>

    <object3D position={[60,1.2,18]} scale={[9,9,9]} rotation={[0,-1.57,0]}>
    <OrbitControls ref={controlsRef} />
    <primitive object={model.scene.clone()}/>;
    </object3D>
    

    <object3D position={[50,1.2,18]} scale={[9,9,9]} rotation={[0,-1.57,0]}>
    <OrbitControls ref={controlsRef} />
    <primitive object={model.scene.clone()}/>;
    </object3D>

    <object3D position={[50,1.2,-2.5]} scale={[9,9,9]} rotation={[0,1.57,0]}>
    <OrbitControls ref={controlsRef} />
    <primitive object={model.scene.clone()}/>;
    </object3D>

    <object3D position={[23,1.2,-25]} scale={[9,9,9]}>
    <OrbitControls ref={controlsRef} />
    <primitive object={model.scene.clone()}/>;
    </object3D>
