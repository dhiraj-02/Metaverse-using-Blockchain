...
const Bench = (props: JSX.IntrinsicElements["group"]) =>{
...
var canvas = document.createElement("canvas");
    ...
    const model = useGLTF("http://localhost:3000/office/Bench.glb")
    ...
    return (
    <>
    <object3D position={[-15,1,-35]} scale={[9,9,9]}>
    <OrbitControls ref={controlsRef} />
    <primitive object={model.scene.clone()}/>;
    </object3D>

    <object3D position={[-35,1,-35]} scale={[9,9,9]}>
    <OrbitControls ref={controlsRef} />
    <primitive object={model.scene.clone()}/>;
    </object3D>
